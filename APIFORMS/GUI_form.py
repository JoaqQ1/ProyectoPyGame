...
class Form(Widget):
    def __init__(self, screen, x,y,w,h,color_background="Black",color_border = "Black", border_size = -1, active = True,path_fondo=""):
        super().__init__(screen, x,y,w,h, color_background, color_border, border_size,path_fondo)
    ...
    def update(self, lista_eventos):
        for widget in self.lista_widgets:
            self._slave.blit(widget._slave,(widget._x,widget._y))
