...
def obtener_rectangulos(principal:pygame.Rect)->dict:
    ...
    diccionario_rect["left"] = pygame.Rect(principal.left,principal.top + diccionario_rect["bottom"].height,6,principal.height - diccionario_rect["bottom"].height*2)
    diccionario_rect["right"] = pygame.Rect(principal.right - 6,principal.top + diccionario_rect["bottom"].height,6,diccionario_rect["left"].height)    
